...
/**
 * Displays a video file. The VideoView class can load images from various sources (such as resources or content providers), takes care of computing its measurement from the video so that it can be used in any layout manager, and provides various display
...
public class FixedVideoView extends SurfaceView implements MediaPlayerControl {
    ...
    public void releasePlayer() {
        ...
        try {
            UiUtils.unbindDrawables(this, false);
        } catch (Exception e) {
        }
    ...
    private OnErrorListener mErrorListener = new OnErrorListener() {
        public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (framework_err == 1 || impl_err == -1004) {
            ...
            // }
            //
            // new AlertDialog.Builder(mContext).setMessage(messageId).setPositiveButton(android.R.string.VideoView_error_button, new DialogInterface.OnClickListener() {
    ...
    public void setOnBufferUpdateListener(OnBufferingUpdateListener _l) {
        mBufferingUpdateListener = _l;
    }
    ...
    public void setOnSeekCompleteListener(OnSeekCompleteListener _listener) {
        mMediaPlayer.setOnSeekCompleteListener(_listener);
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        boolean isKeyCodeSupported = keyCode != KeyEvent.KEYCODE_BACK && keyCode != KeyEvent.KEYCODE_VOLUME_UP && keyCode != KeyEvent.KEYCODE_VOLUME_DOWN && keyCode != KeyEvent.KEYCODE_VOLUME_MUTE && keyCode != KeyEvent.KEYCODE_MENU
